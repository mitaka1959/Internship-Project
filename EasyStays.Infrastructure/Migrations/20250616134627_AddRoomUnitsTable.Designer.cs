...
namespace EasyStays.Infrastructure.Migrations
{
    ...
    [Migration("20250616134627_AddRoomUnitsTable")]
    partial class AddRoomUnitsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyStays.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasyStays.Domain.Entities.RoomUnitReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RoomUnitReservations");
                });
            ...
            modelBuilder.Entity("EasyStays.Domain.Entities.RoomUnitReservation", b =>
                {
                    b.HasOne("EasyStays.Domain.Entities.Reservation", "Reservation")
                        .WithMany("RoomUnitReservations")
                        .HasForeignKey("ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EasyStays.Domain.Entities.RoomUnit", "RoomUnit")
                        .WithMany("RoomUnitReservations")
            ...
            modelBuilder.Entity("EasyStays.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Navigation("RoomUnitReservations");
                });
